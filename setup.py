...
setup_info = {
    ...
    'entry_points': {
        ...
        'zc.buildout': [
            ...
            'google_appengine_sdk = MYAPP.gae.recipe:SDKRecipe',
            'google_appengine_instance = MYAPP.gae.recipe:InstanceRecipe',
            'app.yaml = MYAPP.gae.recipe:AppYamlRecipe',
            'testshell = MYAPP.gae.recipe:TestShellRecipe',
            'remoteshell = MYAPP.gae.recipe:RemoteShellRecipe',
        ],
